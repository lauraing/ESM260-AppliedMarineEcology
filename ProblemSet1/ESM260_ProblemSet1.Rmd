...
surgeonfish_recruit_density <- (surgeonfish_recruit$number * finecoral$density)
...
coraltrout_recruit_density <- (coraltrout_recruit$number * coarsecoral$density)
...
spotted_recruit_density <- (spotted_recruit$number * anemone$density)
...
yellow_recruit_density <- (yellow_recruit$number * moundingcoral$density)
